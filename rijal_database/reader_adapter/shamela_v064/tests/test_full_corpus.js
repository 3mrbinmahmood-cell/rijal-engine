...
(async()=>{
 ...
 const root={ShamelaSanad:{parse:input=>input==='two'?['أحمد بن محمد','سعيد']:['أحمد بن محمد']},RijalDatabaseClient:class{
  ...
  async identityGraph(id,{relation}){return{results:relation==='teacher'?[{name:'سعيد',source_entries:2,mention_id:'mention-1'}]:[],has_more:false}}
 }};
