...
(async()=>{
 ...
 const root={ShamelaSanad:{parse:input=>input==='two'?['أحمد بن محمد','سعيد بن خالد']:['أحمد بن محمد']},RijalDatabaseClient:class{
